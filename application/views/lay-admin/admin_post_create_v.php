    <div class="page-wrapper">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Post Berita</h4>
                        <h6 class="card-subtitle">Ketikla berita yang bagus, jangan HOAX</h6>
                        <form method="post" enctype="multipart/form-data" action="<?= base_url('admin/createpost') ?>">
                            ...
                            <div class="form-group">
                                <textarea name="isi" id="ckeditor" class="textarea_editor form-control" rows="15" placeholder="Enter text ..." style="height:450px"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <input class="btn-primary input-group-btn form-control" type="submit" name="post" value="Post">    
                            </div>
                                    <!-- Form validation -->
