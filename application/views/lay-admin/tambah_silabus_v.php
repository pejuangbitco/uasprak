        ...
        <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Tambah Silabus</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?= base_url('admin/tambah_silabus') ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12 form-validated">
                                    <input type="text" class="form-control"  name="nama_silabus" placeholder="nama silabus" required>
                                </div>
                            </div>
